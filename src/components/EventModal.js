    ...
    <div className="h-screen w-full fixed left-0 top-0 flex justify-center items-center">
      <form className="bg-white rounded-lg shadow-2xl w-1/4">
        <header className="bg-maroon-100 px-4 py-2 flex justify-between items-center">
          <span className="material-icons-outlined text-maroon-400">
            drag_handle
          </span>
          <div>
            {selectedEvent && (
        ...
        <div className="p-3">
          <div className="grid grid-cols-1/5 items-end gap-y-7">
            ...
            <p className="text-maroon-800">{daySelected.format("dddd, MMMM DD")}</p>
            <span className="material-icons-outlined text-maroon-400">
              segment
            </span>
            <input
              ...
              value={description}
              required
              className="pt-3 border-0 text-gray-600 pb-2 w-full border-b-2 border-gray-200 focus:outline-none focus:ring-0 focus:border-maroon-500"
